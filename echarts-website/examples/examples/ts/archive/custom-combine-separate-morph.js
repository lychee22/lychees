...
$.when(
  $.getScript(
    '/echarts-website/cdnThirdParty/fastly.jsdelivr.net/echarts-simple-transform/dist/ecSimpleTransform.min.js'
  ),
  $.getScript(
    '/echarts-website/cdnThirdParty/fastly.jsdelivr.net/echarts-simple-option-player/dist/ecSimpleOptionPlayer.min.js'
  )
).done(function () {
  run();
});
