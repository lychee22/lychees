...
$.when(
  $.getScript(
    '/echarts-website/cdnThirdParty/fastly.jsdelivr.net/echarts-stat@1.2.0/dist/ecStat.min.js'
  ),
  $.getScript(
    '/echarts-website/cdnThirdParty/fastly.jsdelivr.net/echarts-simple-transform@1.0.0/dist/ecSimpleTransform.min.js'
  )
).done(function () {
  init();
