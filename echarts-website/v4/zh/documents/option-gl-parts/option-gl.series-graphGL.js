window.__EC_DOC_option_gl_series_graphGL = {
  ...
  "data": {
    "desc": "<p>节点的数据集。</p>\n<p>数据格式同 <a href=\"/echarts-website/option.html#series-graph.data\" target=\"_blank\">graph.data</a></p>\n"
  },
  "data.name": {
    "desc": "<p>数据项名称。</p>\n"
  },
  ...
  "links": {
    "desc": "<p>节点间的关系数据。\n数据格式同 <a href=\"/echarts-website/option.html#series-graph.links\" target=\"_blank\">graph.links</a></p>\n"
  },
  "links.source": {
