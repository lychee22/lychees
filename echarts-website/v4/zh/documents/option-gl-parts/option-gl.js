window.__EC_DOC_option_gl = {
  ...
  "series-map3D": {
    "desc": "<p><strong>三维地图</strong></p>\n<p>三维地图主要用于地理区域数据的可视化，配合 <a href=\"/echarts-website/option.html#visualMap\" target=\"_blank\">visualMap</a> 组件用于展示不同区域的人口分布密度等数据。</p>\n<p>相比于二维的地图，三维地图还能每个区域设置不同的高度，这个高度能够用来展示数据，也能够用来显示建筑数据中建筑的高度。</p>\n"
  },
  "series-surface": {
  ...
  "series-scatterGL": {
    "desc": "<p>使用 WebGL 绘制的二维散点/气泡图。</p>\n<p>使用方式同 <a href=\"/echarts-website/option.html#series-scatter\" target=\"_blank\">scatter</a>。</p>\n"
  },
  "series-graphGL": {
