window.__EC_DOC_option_gl_series_scatterGL = {
  ...
  "coordinateSystem": {
    "desc": "<p>使用的坐标系。</p>\n<p>同 <a href=\"/echarts-website/option.html#series-scatter.coordinateSystem\" target=\"_blank\">scatter.coordinateSystem</a></p>\n"
  },
  "symbol": {
  ...
  "data": {
    "desc": "<p>散点图的数据集。</p>\n<p>数据格式同 <a href=\"/echarts-website/option.html#series-scatter.data\" target=\"_blank\">scatter.data</a></p>\n"
  },
  "data.name": {
    "desc": "<p>数据项名称。</p>\n"
  },
