window.__EC_DOC_option_gl_series_graphGL = {
  ...
  "data": {
    "desc": "<p>The data set of the node.</p>\n<p>The data format is the same as <a href=\"/echarts-website/option.html#series-graph.data\" target=\"_blank\">graph.data</a></p>\n"
  },
  "data.name": {
  ...
  "links": {
    "desc": "<p>Relational data between nodes.\nThe data format is the same as <a href=\"/echarts-website/option.html#series-graph.links\" target=\"_blank\">graph.links</a></p>\n"
  },
  "links.source": {
