window.__EC_DOC_option_gl = {
  ...
  "series-map3D": {
    "desc": "<p><strong>3D map</strong></p>\n<p>3D maps are mainly used for visualizing geographic area data. With the [visualMap] (<a href=\"/echarts-website/option.html#visualMap\" target=\"_blank\">/echarts-website/option.html#visualMap</a>) component, it can be used to display data such as population distribution density in different regions.</p>\n<p>Compared to 2D maps, 3D maps can set different heights for each area. This height can be used to display data and to display the height of the building in the building data.</p>\n"
  },
  "series-surface": {
  ...
  "series-scatterGL": {
    "desc": "<p>A 2D scatter/bubble plot drawn using WebGL.</p>\n<p>It is used in the same way as <a href=\"/echarts-website/option.html#series-scatter\" target=\"_blank\">scatter</a>.</p>\n"
  },
  "series-graphGL": {
